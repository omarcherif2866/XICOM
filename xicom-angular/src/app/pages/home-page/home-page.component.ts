...
getLeft(i: number): string {
  ...
  team = [
    ...
    { name: 'C.Dubois', secteur: 'Boutique en ligne ', message: '“Accompagnement complet, de la stratégie à l’exécution. L’équipe est disponible et force de proposition. Très satisfait du rendu.”', overlayColor: '#0DF29F', image: '../../../assets/images/feedback/C.webp' },
